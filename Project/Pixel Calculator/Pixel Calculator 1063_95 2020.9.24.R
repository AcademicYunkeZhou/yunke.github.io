...
segments(x0=-line,y0=(t+1)*k,x1=-1,y1=(t+1)*k,col="black")
text(x=-line/1-10,y = (t-13)*k,xpd = T,label = result[3,], pos = 1, cex = 0.58, col = "blue")
text(x=-line/1-25,5,y = (t-13)*k,xpd = T,label = a1[,4], pos = 1, cex = 0.58, col = "black")

# R
text(x=480,y = 900,xpd = T,label = paste0("95mm       ","\n","横竖格距相同      ",
                                          "\n","2020版潘通色卡       "),
     pos = 1, cex = 1.5, col = "black",family = 'H')
